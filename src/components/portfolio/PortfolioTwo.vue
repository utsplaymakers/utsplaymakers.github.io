    ...
    <div v-if="activetab === 1" class="tabcontent">
      <div class="portfolio_list">
        <ul class="gallery_zoom">
          <li v-for="(image, imageIndex) in twentyone" :key="imageIndex">
...
export default {
  data() {
    return {
      ...
      twentyone: [
        {
          thumb: require("../../assets/img/aa/ForYou.png"),
          portfolioName: "For You",
          portfolioType: "Team Bark",
        },
        {
